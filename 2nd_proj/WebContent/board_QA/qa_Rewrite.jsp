...
<body>
	...
	pet_qaVO vo = dao.selectOne(code);

	%>


	<form action="../pet_qaRewrite" method="get"
		...
		<table id="table_set">
			...
			<tr height="30px">
				...
				<td><input type="text" class ="inp" name="title"
					style="display: block; width: 98%" value="<%=vo.getQ_title() %>"></td>
			</tr>
			...
			<tr>
				...
				<td><textarea rows="20"
						...
						name="conts"><%=vo.getQ_content() %></textarea></td>
			</tr>
			<tr>
				<td align="center" colspan="2">
				<input type="hidden" name="code" value="<%=vo.getQ_code() %>">
				<input type="submit" class="btn_wr" value="등록">		
				
				<a href="qa_look.jsp?num=<%=code%>"><input class="btn_wr" type="button" value="취소"></a>
				</td>
			</tr>
