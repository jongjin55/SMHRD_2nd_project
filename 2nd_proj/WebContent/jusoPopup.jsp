...
<% 
	  //한글깨지면 주석제거
	request.setCharacterEncoding("UTF-8");  //해당시스템의 인코딩타입이 EUC-KR일경우에
	response.setCharacterEncoding("utf-8"); // ㅠㅠㅠㅠ
...
function init(){
	...
	var confmKey = "U01TX0FVVEgyMDIxMDIyNzE2MDcwMTExMDg2NTQ=";//승인키
